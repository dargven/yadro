...
class SUserCreate(BaseModel):
    ...
    place: str = Field(..., max_length=50, description="Местоположение, от 3 до 50 символов")
    photo: str = Field(..., min_length=3, max_length=200, description="фото, от 3 до 50 символов")
